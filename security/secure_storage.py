...
Proposal	Section	3.5	(Ethics):	experimental	data	"will	all	be	stored	in	an
encrypted	form	on	the	researcher's	local	machine."	Encrypts/decrypts	results
files	using	Fernet	(AES-128-CBC	+	HMAC	via	the	`cryptography`	package).
No	dependency	on	which	dataset	calibrated	the	detector.
Usage:
